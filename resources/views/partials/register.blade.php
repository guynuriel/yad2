<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModal"
    aria-hidden="true">
    <div style="margin-top: calc(50vh - 300px);" class="modal-dialog" role="document">
        <div class="modal-content">
            <div id="register_wrapper" class="flex" style="width: 700px;">
                        ...
                        <form id="registerForm" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <p class="flex center_content">כבר רשום?  
                                    <a class="nav-link pointer" type="button" class="close" data-dismiss="modal" aria-label="Close"
                                        data-toggle="modal" 
                                        data-target="#loginModal">להתחברות
                                    </a>
                                </p>
                            </div>
                        </form>
